...
const LandingPage = () => {
    ...
    return (
        <div style={{ backgroundColor: "#FAF9F8", color: "#2F2F2F", minHeight: "100vh" }}>
            ...
            {/* Sección Hero */}
            <section id="inicio" className="hero" style={{ background: "url('/Invited.jpg') center/cover no-repeat", position: 'relative' }}>
                <div className="hero-overlay">
                    <div className="container hero-content">
                        <h1>{t('title')}</h1>
                        <p>{t('subtitle')}</p>
                        {user ? (
                            <Link to={localizedLink(`/${user.name}&${user.partner.name}/invitation/plantilla/form`)} className="btn btn-primary">
                                {t('titleButton')}
                            </Link>
                        ) : (
            ...
            <section id="como-funciona" className="como-funciona">
                <div className="container">
                    ...
                    <div className="pasos">
                        <div className="paso"><span>1</span><h3>{t('howItWorks.cardTitle1')}</h3><p>{t('howItWorks.cardText1')}</p></div>
                        <div className="paso"><span>2</span><h3>{t('howItWorks.cardTitle2')}</h3><p>{t('howItWorks.cardText2')}</p></div>
                        <div className="paso"><span>3</span><h3>{t('howItWorks.cardTitle3')}</h3><p>{t('howItWorks.cardText3')}</p></div>
                        <div className="paso"><span>4</span><h3>{t('howItWorks.cardTitle4')}</h3><p>{t('howItWorks.cardText4')}</p></div>
                    </div>
                </div>
            </section>
